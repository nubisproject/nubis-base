...
package { 'bind9-host':
  ensure => '1:9.9.5.dfsg-3ubuntu0.7',
}
package { 'binutils':
...
package { 'cloud-guest-utils':
  ensure => '0.27-0ubuntu9.1',
}
package { 'cloud-init':
  ensure => '0.7.5-0ubuntu1.15',
}
package { 'colorama':
  ensure => '0.2.5',
}
...
package { 'libnuma1':
  ensure => '2.0.9~rc5-1ubuntu3.14.04.1',
}
package { 'libopts25':
...
package { 'linux-headers-3.13.0-79':
  ensure => '3.13.0-79.123',
}
package { 'linux-headers-3.13.0-79-generic':
  ensure => '3.13.0-79.123',
}
...
package { 'linux-image-3.13.0-79-generic':
  ensure => '3.13.0-79.123',
}
