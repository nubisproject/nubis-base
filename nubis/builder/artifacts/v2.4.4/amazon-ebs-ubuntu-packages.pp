...
package { 'bind9-host':
  ensure => '1:9.10.3.dfsg.P4-8ubuntu1.15',
}
package { 'binutils':
...
package { 'bsdutils':
  ensure => '1:2.27.1-6ubuntu3.8',
}
package { 'btrfs-tools':
  ensure => '4.4-1ubuntu1.1',
}
...
package { 'cloud-init':
  ensure => '19.2-36-g059d049c-0ubuntu2~16.04.1',
}
...
package { 'libpython2.7':
  ensure => '2.7.12-1ubuntu0~16.04.8',
}
...
package { 'linux-aws':
  ensure => '4.4.0.1095.99',
}
package { 'linux-aws-headers-4.4.0-1092':
  ensure => '4.4.0-1092.103',
}
package { 'linux-aws-headers-4.4.0-1095':
  ensure => '4.4.0-1095.106',
}
package { 'linux-base':
  ensure => '4.5ubuntu1~16.04.1',
}
package { 'linux-headers-4.4.0-1092-aws':
  ensure => '4.4.0-1092.103',
}
package { 'linux-headers-4.4.0-1095-aws':
  ensure => '4.4.0-1095.106',
}
package { 'linux-headers-aws':
  ensure => '4.4.0.1095.99',
}
package { 'linux-image-4.4.0-1092-aws':
  ensure => '4.4.0-1092.103',
}
package { 'linux-image-4.4.0-1095-aws':
  ensure => '4.4.0-1095.106',
}
...
package { 'linux-libc-dev':
  ensure => '4.4.0-165.193',
}
package { 'linux-modules-4.4.0-1092-aws':
  ensure => '4.4.0-1092.103',
}
package { 'linux-modules-4.4.0-1095-aws':
  ensure => '4.4.0-1095.106',
}
package { 'locale':
  ensure => ['2.1.2'],
